...
const experiences = [
  ...
  },
  {
    ...
    company_name: "Sundas Foundation",
    icon: sundas,
    iconBg: "#E6DEDD",
    date: "October 2025 - Present",
    points: [
      "I'm responsible of creating and mananging web applications.",
      "Managing ERP system and all the activities of IT department.",
      "Implementing API integration and ensuring server compatibility and scalability.",
